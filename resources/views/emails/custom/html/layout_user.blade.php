                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                                <tr>
                                    <td class="content-cell">
                                        ...
                                        {{-- <p class="text-right">تم اعادة تعين كلمة المرور بنجاح</p> --}}
                                        <p class="text-right">{{$message1}}</p>
                                        <p class="text-right">{{$message2}}</p>
                                        <p class="text-right">{{$message3}}</p>
                                        <p class="text-right">رابط المنصة {{\Request::getHost()}} نسعد بخدمتكم على مدار ٢٤ ساعة</p>
