...
<tr  class="h-40px">
    <th scope="row">
        <a href="{{route('admin.public_orders.edit',['order' => $order->id])}}" target="_blank">
            {{$order->id}}
        </a>
    </th>
    ...
    <td><a href="/admin/chat/public/{{$order->id}}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="محادثة">
            <i class="fab fa-whatsapp"></i>
        </a></td>
</tr>
@endforeach
