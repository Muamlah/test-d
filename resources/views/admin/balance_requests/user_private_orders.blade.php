    ...
    setTimeout(function() { 
        ...
        let KTDatatableRemoteAjaxDemoPrivate = function() {
            ...
            let demo = function() {
                ...
                let datatable = $('#kt-user-private-orders').KTDatatable({
                    // datasource definition
                    data: {
                        type: 'remote',
                        source: {
                            read: {
                                url: HOST_URL +'/admin/get-data/user-private-orders/'+"{{$user_id}}"+'/'+"{{$status}}",
                    ...
                    // },
                        ...
                        template: function(row) {
                            ...
                            if(row.status_id == 1){
                                ...
                                return '<span class="label font-weight-bold label-lg label-inline label-light-warning">غير موافق</span>';
