    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap py-3">
            <div class="card-title">
                <h3 class="card-label"> كل الطلبات </h3>
            </div>
...
@endsection
@section('script')
    @include('admin.balance_requests.user_private_orders',['user_id'=>$user->id , 'status'=>null])
    @include('admin.balance_requests.user_public_orders',['user_id'=>$user->id , 'status'=>null])
    @include('admin.balance_requests.user_eservices_orders',['user_id'=>$user->id , 'status'=>null])
@endsection
