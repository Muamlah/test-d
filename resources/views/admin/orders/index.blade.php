...
{{--                                    </li>--}}
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade active show" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <div>
                        <div class="datatable datatable-bordered datatable-head-custom" id="kt-report-public-orders"></div>

                    </div>
                </div>
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    <div>
                        <div class="datatable datatable-bordered datatable-head-custom" id="kt-report-private-orders"></div>
                    </div>
                </div>
                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                    <div>
                        <div class="datatable datatable-bordered datatable-head-custom" id="kt-report-eservices-orders"></div>
                    </div>
                </div>
            </div>
        </div>
...
@endsection
@section('script')
    @include('admin.orders.report_private_orders')
    @include('admin.orders.report_public_orders')
    @include('admin.orders.report_eservices_orders')
@endsection
