        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                ...
                <div class="card-title m-0">
                    <h3 class="fw-bolder m-0">إضافة @if(request()->base_type == 'update') التحديثات @else الصفحات @endif</h3>
                </div>
                <!--end::Card title-->
            </div>
            <!--begin::Card header-->
            ...
            <div id="kt_account_profile_details" class="collapse show">
                ...
                <form method="post" action="{{route('admin.pages.store')}}"
                    ...
                    {{ csrf_field() }}
                    <input type="hidden" name="base_type" value="{{request()->base_type}}">
                    <!--begin::Card body-->
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-9 fv-row">
                                    <textarea name="details" id="kt-tinymce-4" class="form-control form-control-lg form-control-solid"></textarea>
                            </div>
                            <!--end::Col-->
                        </div>
                    </div>
