...
{{--  </li>--}}
  ...
  <li class="nav-item">
    <a class="nav-link" id="tab4-tab" data-toggle="tab" href="#tab4" role="tab" aria-controls="tab4" aria-selected="false">({{$balance_orders_count}}) طلبات السحب</a>
  </li>
</ul>
<div class="tab-content" id="myTabContent">
  ...
  <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
    <table class="">
      ...
      <tfoot>
        <tr>
          <td colspan="7">
            <a class="btn btn-success w-100 see-more" data-page="1" data-link="{{route('admin.current_orders',['type' => 'private'])}}" data-div="#private-head" href="javascript:;">تحميل المزيد</a>
          </td>
        </tr>
      </tfoot>
    </table>
  ...
  <div class="tab-pane fade" id="tab4" role="tabpanel" aria-labelledby="tab4-tab">
    <table class="">
      ...
      <tbody id="balance-head">

      </tbody>
      <tfoot>
        <tr>
          <td colspan="7">
            <a class="btn btn-success w-100 see-more" data-page="1" data-link="{{route('admin.current_orders',['type' => 'balance'])}}" data-div="#balance-head" href="javascript:;">تحميل المزيد</a>
          </td>
        </tr>
      </tfoot>
    </table>
