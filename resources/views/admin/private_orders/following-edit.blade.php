        ...
        <div id="kt_content_container" class="container">
            ...
            <div class="card card-custom">
                ...
                <div id="kt_account_profile_details" class="collapse show">
                    <form method="post" action="{{url('admin/private_orders-following/').'/'.$order->id}}" enctype="multipart/form-data" class="form" >
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="fees" value="{{$order->fees}}" />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <label>ضريبة القيمة المظافة:</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="value_added_tax" value="{{$order->value_added_tax}}" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    <label> المبلغ المستحق لمقدم الخدمة عند اتمام الطلب:</label>
                                    <div class="input-group">
                                        <input type="text" name="payable_service_provider" class="form-control" value="{{$order->payable_service_provider}}" />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <label>ضريبة على مقدم الخدمة :</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control"  name="provider_fees" value="{{$order->provider_fees}}" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    <label>ضريبة قيمة مظافة على مقدم الخدمة :</label>
                                    <div class="input-group">
                                        <input type="text" name="provider_value_added_tax" class="form-control" value="{{$order->provider_value_added_tax}}" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
