                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-3 my-2 my-md-0">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="kt_datatable_date_from" placeholder="من تاريخ">
                                </div>
                            </div>
                            <div class="col-md-3 my-2 my-md-0">
                                <div class="form-group">
    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap py-3">
            <div class="card-title">
                <h3 class="card-label">طلبات التعميد التابع </h3>
            </div>
...
@endsection
@section('script')
    {{-- <script src="{{ asset('admin-file/assets/js/pages/crud/ktdatatable/base/following-private-orders.js') }}"></script> --}}
    <script>
        "use strict";
            ...
            let demo = function () {
                let datatable = $('#kt-private-orders').KTDatatable({
                    data: {
                        ...
                        source: {
                            read: {
                                url: HOST_URL + '/admin/get-data/following-private-orders/' + "{{$order_id}}",
                                map: function (raw) {
                                    // sample data mapping
                                    let dataSet = raw;
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            template: function (row) {
                                let following = ''
                                if (row.check && row.status_id == 8) {
                                    following = `<a target="_blank" href="${HOST_URL}/admin/following_private_orders/${row.id}/edit" title="تعميد تابع">
                                 <i class="flaticon-edit-1  text-primary"></i>
                                </a>`;
                                } else {
                                    following = `<a href="${HOST_URL}/admin/private_orders/${row.id}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit details">
                                        <i class="flaticon-edit-1  text-primary"></i>
                                    </a>`
                                }
                                return `
