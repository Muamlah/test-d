...
@section('headings')
    @include('admin.include.headings',[
        ...
        'title1'        => ' قائمة عمليات النظام',
        'link1'         => url('admin/transactions'),
    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap py-3">
            <div class="card-title">
                <h3 class="card-label">قائمة عمليات النظام </h3>
            </div>
        ...
        <div class="card-body">
            ...
            <!--end: Search Form-->
            <!--begin: Datatable-->
            <div class="datatable datatable-bordered datatable-head-custom" id="kt-transactions"></div>
            <!--end: Datatable-->
        </div>
    </div>
...
@endsection
@section('script')
    <script src="{{ asset('admin-file/assets/js/pages/crud/ktdatatable/base/transactions.js') }}"></script>
@endsection
