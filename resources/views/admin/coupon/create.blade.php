            ...
            <div id="kt_account_profile_details" class="collapse show">
                ...
                <form method="post" action="{{route('admin.coupon.store')}}"
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <h3 style="color:green; text-align:center;"> تم انشاء البطاقة بنجاح </h3>
                        <br>
                        @endif
                        ...
                        <div class="row mb-6" >
                            <label class="col-lg-3 col-form-label required fw-bold fs-6">قيمة البطاقة </label>
                            <div class="col-lg-9 fv-row">
                        ...
                        <div class="row mb-6" id="owner_discount">
                            ...
                            <div class="col-lg-9 fv-row">
                                <input type="text" name="owner_discount"
                                    class="form-control form-control-lg form-control-solid" value="" placeholder="اترك الحقل فارغ في حال لا يوجد حسم للمستخدم صاحب الكود"/> 
                            </div>
                            <!--end::Col-->
                        </div>
                        <div class="row mb-6" id="owner_phone">
