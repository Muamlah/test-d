@extends('admin.layouts.adminLayout') @section('title') طلب سحب رصيد
@endsection
@section('content')
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                ...
                <div class="card-title m-0">
                    <h3 class="fw-bolder m-0">طلب سحب رصيد</h3>
                </div>
                <!--end::Card title-->
            </div>
            <!--begin::Card header-->
            ...
            <div id="kt_account_profile_details" class="collapse show">
                <!--begin::Form-->
                <form method="post" action="{{route('admin.updateBalanceRequestDetails',['id' => $data->id])}}"
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <h3 style="color:green; text-align:center;"> تم تعديل السؤال بنجاح </h3>
                        <br>
                        @endif
                        @if($errors->any())
                            ...
                            <div class="col-lg-9 fv-row">
                                <select name="type" data-placeholder="اختر .." class="form-select selectpicker form-select-solid form-select-lg">
                                    @foreach($types as $key=>$type)
                                        <option  value="{{$key}}" @if(@$faq->type == $key) selected @endif>{{$type['title']}}</option>
                                   @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-9 fv-row">
                                <input type="text" name="question"
                                    class="form-control form-control-lg form-control-solid" value="{{$faq->question}}" /> 
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-9 fv-row">
                                    <textarea name="answer" id="kt-tinymce-4" class="form-control form-control-lg form-control-solid">{{$faq->answer}}</textarea>
                            </div>
                            <!--end::Col-->
                        </div>
                    </div>
