        ...
        <div class="card card-style bg-theme pb-0">
            <div class="content">
                ...
                <div class="tab-content" id="tab-private">
                    <div class="pt-2">
                        <form method="post" id="form_add" action="{{route('followingOrder.store')}}"
                            ...
                            <div class="input-style input-style-2  has-icon input-required">
                                ...
                                <em>(مطلوب)</em>
                                <input class="form-control  service-provider-phone"  type="tel" title="يجب ان يكون رقم هاتف سعودي"
...
{{--                            </div>--}}
                            ...
                            <div class="input-style input-style-2 has-icon input-required">
                                ...
                                <em>(مطلوب)</em>
                                <input class="form-control" type="number"  autocomplete="off" value="{{round($order->payable_service_provider,2)}}" required name="price" placeholder="">
                            </div>
                            <div class="input-style input-style-2 has-icon input-required">
