            ...
            <div id="scroll" class="content scroll"  id="messages">
                @foreach($message->children as $child)
                    @if(!is_null($child->file))
                        ...
                        <div class="speech-bubble speach-image speech-{{auth()->user()->id == $child->user_id ? 'left bg-msg-send mb-0' : 'right bg-msg-r mb-3'}} bg-highlight message-item" data-id="{{ $child->id }}">
...
{{--                        @if(auth()->user()->id == $child->user_id)--}}
{{--                            <div class="clearfix"></div>--}}
{{--                            <div class="speech-read mb-3"><i class="fas fa-check-double check-color"></i></div>--}}
{{--                        @endif--}}
                    @endif
                @endforeach
