...
<div class="speech-bubble speach-image speech-left color-black message-item" data-id="{{ $message->id }}">
...
@else
<div class="clearfix"></div>
<div class="speech-bubble speech-left bg-msg-send message-item" data-id="{{ $message->id }}">
