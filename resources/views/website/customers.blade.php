...
<head>
    ...
    <title>الخدمات الحكومية | منصة معاملة </title>
    @yield('pageMeta')
        ...
        <div class="container pt-5" id="sec-1">
            <div class="row1 inverted mt-2">
                ...
                <div class="row1-col photo">
                    <img src="{{asset('muamlah-main/assets/images/logos.jpeg')}}" >
                ...
                <div class="col-lg-10 text-center">
                    ...
                    <div class="accordion accordion-flush" id="faqlist">
                        <div class="accordion-item mb-3 shadow-sm text-end border">
                            ...
                            <div id="faq-content-1" class="accordion-collapse collapse" data-bs-parent="#faqlist" style="">
                                <div class="accordion-body">
                                    التعميد هو ضمان حقوق العميل و مقدم الخدمة إلى حين تنفيذ الخدمة.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item mb-3 shadow-sm text-end border">
                            ...
                            <div id="faq-content-2" class="accordion-collapse collapse" data-bs-parent="#faqlist" style="">
                                <div class="accordion-body">
                                    ...
                                    التعميد الخاص :<br>
                                    طلب عميل برقم جوال مقدم خدمة محدد إضغط هنا للإطلاع على طريقة طلب التعميد الخاص
                                    التعميد العام :<br>
                                    اي عميل جديد ليس لديه مقدم خدمة،  يمكنه ارسال طلب تعميد و يظهر لجميع مقدمي الخدمة في نفس الوقت و سوف يختار العميل من العروض إضغط هنا للإطلاع على طريقة طلب التعميد العام
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item mb-3 shadow-sm text-end border">
                            <h3 class="accordion-header mt-0">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-3" aria-expanded="false">
                                    <svg class="svg-inline--fa fa-circle-question fa-w-16 ms-2 text-success" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle-question" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0zM256 400c-18 0-32-14-32-32s13.1-32 32-32c17.1 0 32 14 32 32S273.1 400 256 400zM325.1 258L280 286V288c0 13-11 24-24 24S232 301 232 288V272c0-8 4-16 12-21l57-34C308 213 312 206 312 198C312 186 301.1 176 289.1 176h-51.1C225.1 176 216 186 216 198c0 13-11 24-24 24s-24-11-24-24C168 159 199 128 237.1 128h51.1C329 128 360 159 360 198C360 222 347 245 325.1 258z"></path></svg><!-- <i class="fas fa-question-circle ms-2 text-success"></i> Font Awesome fontawesome.com -->
                                    ليس لدي مقدم خدمة ، كيف أطلب التعميد ؟
                                </button>
                            </h3>
                            <div id="faq-content-3" class="accordion-collapse collapse" data-bs-parent="#faqlist" style="">
                                <div class="accordion-body">
                                    يمكنك إرسال طلب تعميد عام و يظهر لجميع مقدمي الخدمة في نفس الوقت و سوف يختار العميل من العروض إضغط هنا للإطلاع على طريقة طلب التعميد العام
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item mb-3 shadow-sm text-end border">
                            <h3 class="accordion-header mt-0">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-4" aria-expanded="false">
                                    <svg class="svg-inline--fa fa-circle-question fa-w-16 ms-2 text-success" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle-question" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0zM256 400c-18 0-32-14-32-32s13.1-32 32-32c17.1 0 32 14 32 32S273.1 400 256 400zM325.1 258L280 286V288c0 13-11 24-24 24S232 301 232 288V272c0-8 4-16 12-21l57-34C308 213 312 206 312 198C312 186 301.1 176 289.1 176h-51.1C225.1 176 216 186 216 198c0 13-11 24-24 24s-24-11-24-24C168 159 199 128 237.1 128h51.1C329 128 360 159 360 198C360 222 347 245 325.1 258z"></path></svg><!-- <i class="fas fa-question-circle ms-2 text-success"></i> Font Awesome fontawesome.com -->
                                    كيف يتم تأكيد استلامي لطلبي ؟
                                </button>
                            </h3>
                            <div id="faq-content-4" class="accordion-collapse collapse" data-bs-parent="#faqlist" style="">
                                <div class="accordion-body">
                                    بعد إنتهاء مقدم الخدمة من تنفيذ الطلب يقوم بتسليم الطلب بعدها يتم إرسال تنبيه إلى العميل حتى يقوم بتأكيد إستلام الطلب عبر زر تأكيد الإستلام
                        ...
                        <div class="accordion-item mb-3 shadow-sm text-end border">
                            <h3 class="accordion-header mt-0">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-5" aria-expanded="false">
                                    <svg class="svg-inline--fa fa-circle-question fa-w-16 ms-2 text-success" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle-question" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0zM256 400c-18 0-32-14-32-32s13.1-32 32-32c17.1 0 32 14 32 32S273.1 400 256 400zM325.1 258L280 286V288c0 13-11 24-24 24S232 301 232 288V272c0-8 4-16 12-21l57-34C308 213 312 206 312 198C312 186 301.1 176 289.1 176h-51.1C225.1 176 216 186 216 198c0 13-11 24-24 24s-24-11-24-24C168 159 199 128 237.1 128h51.1C329 128 360 159 360 198C360 222 347 245 325.1 258z"></path></svg><!-- <i class="fas fa-question-circle ms-2 text-success"></i> Font Awesome fontawesome.com -->
                                    متى يحصل مقدم الخدمة على المبلغ ؟

                                </button>
                            </h3>
                            <div id="faq-content-5" class="accordion-collapse collapse" data-bs-parent="#faqlist" style="">
                                <div class="accordion-body">
                                    بعد تأكيد إستلام الطلب من طرف العميل عبر زر تأكيد الإستلام يتم تحويل المبلغ إلى حساب مقدم الخدمة
                        ...
                        <div class="accordion-item mb-3 shadow-sm text-end border">
                            <h3 class="accordion-header mt-0">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-6" aria-expanded="false">
                                    <svg class="svg-inline--fa fa-circle-question fa-w-16 ms-2 text-success" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle-question" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0zM256 400c-18 0-32-14-32-32s13.1-32 32-32c17.1 0 32 14 32 32S273.1 400 256 400zM325.1 258L280 286V288c0 13-11 24-24 24S232 301 232 288V272c0-8 4-16 12-21l57-34C308 213 312 206 312 198C312 186 301.1 176 289.1 176h-51.1C225.1 176 216 186 216 198c0 13-11 24-24 24s-24-11-24-24C168 159 199 128 237.1 128h51.1C329 128 360 159 360 198C360 222 347 245 325.1 258z"></path></svg><!-- <i class="fas fa-question-circle ms-2 text-success"></i> Font Awesome fontawesome.com -->
                                    مقدم الخدمة أنجز جزء من الخدمة ، كيف يتم حسابه ؟

                                </button>
                            </h3>
                            <div id="faq-content-6" class="accordion-collapse collapse" data-bs-parent="#faqlist" style="">
                                <div class="accordion-body">
                                    عند إنجاز جزء من الخدمة يجب الإتفاق بين العميل و مقدم الخدمة عبر المحادثة المفتوحة على منصة معاملة لتحديد قيمة الخدمة ثم الضغط على زر تسليم الطلب ثم كتابة المبلغ الذي تم الإتفاق عليه                                </div>
                            </div>
                        </div>
                        <div class="accordion-item mb-3 shadow-sm text-end border">
                            <h3 class="accordion-header mt-0">
                            ...
                            <div id="faq-content-7" class="accordion-collapse collapse" data-bs-parent="#faqlist" style="">
                                <div class="accordion-body">
                                    يمكن إلغاء الطلب عبر زر إلغاء الطلب الموجود على صفحة الطلب
                        ...
                        <div class="accordion-item mb-3 shadow-sm text-end border">
                            <h3 class="accordion-header mt-0">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-8" aria-expanded="false">
                                    <svg class="svg-inline--fa fa-circle-question fa-w-16 ms-2 text-success" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle-question" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0zM256 400c-18 0-32-14-32-32s13.1-32 32-32c17.1 0 32 14 32 32S273.1 400 256 400zM325.1 258L280 286V288c0 13-11 24-24 24S232 301 232 288V272c0-8 4-16 12-21l57-34C308 213 312 206 312 198C312 186 301.1 176 289.1 176h-51.1C225.1 176 216 186 216 198c0 13-11 24-24 24s-24-11-24-24C168 159 199 128 237.1 128h51.1C329 128 360 159 360 198C360 222 347 245 325.1 258z"></path></svg><!-- <i class="fas fa-question-circle ms-2 text-success"></i> Font Awesome fontawesome.com -->
                                    كيف أسحب رصيدي في المحفظة ؟

                                </button>
                            </h3>
                            <div id="faq-content-8" class="accordion-collapse collapse" data-bs-parent="#faqlist" style="">
                                <div class="accordion-body">
                                    يمكن سحب الرصيد المتاح في أي وقت عبر زر سحب الرصيد في صفحة المحفظة
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item mb-3 shadow-sm text-end border">
                            <h3 class="accordion-header mt-0">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-9" aria-expanded="false">
                                    <svg class="svg-inline--fa fa-circle-question fa-w-16 ms-2 text-success" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle-question" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0zM256 400c-18 0-32-14-32-32s13.1-32 32-32c17.1 0 32 14 32 32S273.1 400 256 400zM325.1 258L280 286V288c0 13-11 24-24 24S232 301 232 288V272c0-8 4-16 12-21l57-34C308 213 312 206 312 198C312 186 301.1 176 289.1 176h-51.1C225.1 176 216 186 216 198c0 13-11 24-24 24s-24-11-24-24C168 159 199 128 237.1 128h51.1C329 128 360 159 360 198C360 222 347 245 325.1 258z"></path></svg><!-- <i class="fas fa-question-circle ms-2 text-success"></i> Font Awesome fontawesome.com -->
                                    لدي خلاف مع مقدم الخدمة ، ماذا أفعل ؟

                                </button>
                            </h3>
                            <div id="faq-content-9" class="accordion-collapse collapse" data-bs-parent="#faqlist" style="">
                                <div class="accordion-body">
                                    يمكنك الإتصال بالدعم الفني عبر خدمة العملاء وسوف يتم حل الخلاف حسب المشكلة وتقدير الدعم الفني لها.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item mb-3 shadow-sm text-end border">
                            <h3 class="accordion-header mt-0">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-10" aria-expanded="false">
                                    <svg class="svg-inline--fa fa-circle-question fa-w-16 ms-2 text-success" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle-question" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0zM256 400c-18 0-32-14-32-32s13.1-32 32-32c17.1 0 32 14 32 32S273.1 400 256 400zM325.1 258L280 286V288c0 13-11 24-24 24S232 301 232 288V272c0-8 4-16 12-21l57-34C308 213 312 206 312 198C312 186 301.1 176 289.1 176h-51.1C225.1 176 216 186 216 198c0 13-11 24-24 24s-24-11-24-24C168 159 199 128 237.1 128h51.1C329 128 360 159 360 198C360 222 347 245 325.1 258z"></path></svg><!-- <i class="fas fa-question-circle ms-2 text-success"></i> Font Awesome fontawesome.com -->
                                    ماهي الخدمة الالكترونية ؟

                                </button>
                            </h3>
                            <div id="faq-content-10" class="accordion-collapse collapse" data-bs-parent="#faqlist" style="">
                                <div class="accordion-body">
                                    هي الخدمات الحكومية الالكترونية مثل :<br>

                                    طلب اصدار تجديد تعديل سجل تجاري<br>
                                    طلب اصدار تجديد تعديل رخصة بلدي<br>
                                    جميع خدمات وزارة العمل ، ابشر ، الزكاة ، التجارة ، بلدي
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item mb-3 shadow-sm text-end border">
                            <h3 class="accordion-header mt-0">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-11" aria-expanded="false">
                                    <svg class="svg-inline--fa fa-circle-question fa-w-16 ms-2 text-success" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle-question" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0zM256 400c-18 0-32-14-32-32s13.1-32 32-32c17.1 0 32 14 32 32S273.1 400 256 400zM325.1 258L280 286V288c0 13-11 24-24 24S232 301 232 288V272c0-8 4-16 12-21l57-34C308 213 312 206 312 198C312 186 301.1 176 289.1 176h-51.1C225.1 176 216 186 216 198c0 13-11 24-24 24s-24-11-24-24C168 159 199 128 237.1 128h51.1C329 128 360 159 360 198C360 222 347 245 325.1 258z"></path></svg><!-- <i class="fas fa-question-circle ms-2 text-success"></i> Font Awesome fontawesome.com -->
                                    كيف أطلب خدمة الكترونية ؟

                                </button>
                            </h3>
                            <div id="faq-content-11" class="accordion-collapse collapse" data-bs-parent="#faqlist" style="">
                                <div class="accordion-body">
                                    إضغط هنا للإطلاع على طريقة طلب خدمة الكترونية
                        ...
                        <div class="accordion-item mb-3 shadow-sm text-end border">
                            ...
                            <div id="faq-content-12" class="accordion-collapse collapse" data-bs-parent="#faqlist" style="">
                                <div class="accordion-body">
                                    تختلف الرسوم حسب المبلغ و ستظهر الرسوم عند تعبئة نموذج الطلب قبل الدفع
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item mb-3 shadow-sm text-end border">
                            <h3 class="accordion-header mt-0">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-13" aria-expanded="false">
                                    <svg class="svg-inline--fa fa-circle-question fa-w-16 ms-2 text-success" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle-question" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0zM256 400c-18 0-32-14-32-32s13.1-32 32-32c17.1 0 32 14 32 32S273.1 400 256 400zM325.1 258L280 286V288c0 13-11 24-24 24S232 301 232 288V272c0-8 4-16 12-21l57-34C308 213 312 206 312 198C312 186 301.1 176 289.1 176h-51.1C225.1 176 216 186 216 198c0 13-11 24-24 24s-24-11-24-24C168 159 199 128 237.1 128h51.1C329 128 360 159 360 198C360 222 347 245 325.1 258z"></path></svg><!-- <i class="fas fa-question-circle ms-2 text-success"></i> Font Awesome fontawesome.com -->
                                    كم رسوم الخدمة الالكترونية ؟

                                </button>
                            </h3>
                            <div id="faq-content-13" class="accordion-collapse collapse" data-bs-parent="#faqlist" style="">
                                <div class="accordion-body">
                                    تختلف الرسوم حسب المبلغ و ستظهر الرسوم عند تعبئة نموذج الطلب قبل الدفع
                                </div>
                            </div>
                        ...
                        <div class="accordion-item mb-3 shadow-sm text-end border">
                            ...
                            <div id="faq-content-14" class="accordion-collapse collapse" data-bs-parent="#faqlist" style="">
                                <div class="accordion-body">
                                    طريقة الدفع المعتمدة عن طريق بطاقة مدى.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item mb-3 shadow-sm text-end border">
                            ...
                            <div id="faq-content-15" class="accordion-collapse collapse" data-bs-parent="#faqlist" style="">
                                <div class="accordion-body">
                                    نعم، طريقة الدفع أمنة و مشفرة من جهة البنك.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item mb-3 shadow-sm text-end border">
                            <h3 class="accordion-header mt-0">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-16" aria-expanded="false">
                                    <svg class="svg-inline--fa fa-circle-question fa-w-16 ms-2 text-success" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle-question" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0zM256 400c-18 0-32-14-32-32s13.1-32 32-32c17.1 0 32 14 32 32S273.1 400 256 400zM325.1 258L280 286V288c0 13-11 24-24 24S232 301 232 288V272c0-8 4-16 12-21l57-34C308 213 312 206 312 198C312 186 301.1 176 289.1 176h-51.1C225.1 176 216 186 216 198c0 13-11 24-24 24s-24-11-24-24C168 159 199 128 237.1 128h51.1C329 128 360 159 360 198C360 222 347 245 325.1 258z"></path></svg><!-- <i class="fas fa-question-circle ms-2 text-success"></i> Font Awesome fontawesome.com -->
                                    لم يتم قبول طلبي لماذا ؟

                                </button>
                            </h3>
                            <div id="faq-content-16" class="accordion-collapse collapse" data-bs-parent="#faqlist" style="">
                                <div class="accordion-body">
                                    قد يكون طلبك غير واضح، أو قد يكون مخالف للشروط و الأحكام.
                                </div>
                            </div>
                        </div>
                    </div>
