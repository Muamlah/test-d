...
{{--                        </strong>--}}
                        @auth
                            @php
                                $href = route('supervisors',['service_id' => $r->id]);
                                $type   = 'add';
            ...
            <div class="d-flex mr-2">
                ...
                @else
                    <div class="mr-auto">
                        <a href="{{route('login')}}"   style="background-color:#837f7f !important" class="f-b added-to-favorite-2 float-left rounded-xs text-uppercase float-left font-11 pr-3 pl-3 pb-1 pt-1">مهتم
                        </a>
                    </div>
                @endauth
            </div>
