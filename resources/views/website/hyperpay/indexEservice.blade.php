            ...
            <div class="content mb-0">
                    ...
                    <div class="col-3 p-0 text-center">
                        <div class="mx-0 mb-3">
                            ...
                            <h3 class="color-gray2-dark font-16 mb-0">
                                {{$order->fees + $order->value_added_tax}} ريال
                            </h3>
                        </div>
                    </div>
                ...
                <div class="row mb-0">
                    ...
                    @if( $order->total_amount - $order->deserved_price == 0)
                        <div class="col-{{$order->getDiscount() > 0 ? '4' : '6'}} text-center">
                            <div class="mx-0 mb-3 text-center">
                        ...
                        <div class="col-{{$order->getDiscount() > 0 ? '4' : '6'}} text-center">
                            <div class="mx-0 mb-3">
                                ...
                                <h3 class="color-gray2-dark font-16 mb-0 discount">{{$order->total_amount}} ريال</h3>
                            </div>
                        </div>
                    @else
                        <div class="col-{{$order->getDiscount() > 0 ? '3' : '4'}} text-center">
                            <div class="mx-0 mb-3 text-center">
                                <h6 class="font-14 font-800 text-uppercase color-gray3-light">حالة الدفع</h6>
                                <h3 class="color-gray2-dark font-16 mb-0">في الانتظار</h3>
                            </div>
                ...
                <div class="mt-2">
                    <form action="{{ route('hyperpay.response',['id'=>$order->id,'type'=>$type])}}" class="paymentWidgets" data-brands="VISA MADA"></form>
                </div>
            </div>
        </div>
