...
<head>
    ...
    <title>مقدمي الخدمات | منصة معاملة </title>
    @yield('pageMeta')
        ...
        <div class="navbar sticky w-nav">
            <div class="row">
                <div class="col-6 my-auto">
                    <a href="{{url('/')}}" aria-current="page" class="w-nav-brand">
...
<div class="section bg-gray-4">
    <div class="container">
        <div class="w-layout-grid split-section">
            <div id="w-node-285f34097b94-a7669354" class="justify-column-between content-width-small">
                ...
                <div>
                    ...
                    <div class="border-bottom space-bottom">
                        ...
                        <p class="paragraph greyish">سجل في الدروات في قسم التدريب و تدرب على الخدمات الالكترونية
                            الأكثر
            ...
            <img loading="lazy" width="498" id="w-node-285f34097ba8-a7669354" alt="" src="muamlah-main/assets/images/feat6.png" class="align-self-center ls-is-cached lazyloaded">
                ...
                <div class="accordion accordion-flush" id="faqlist">
                    <div class="accordion-item mb-3 shadow-sm text-end border">
                        ...
                        <div id="faq-content-0000" class="accordion-collapse collapse" data-bs-parent="#faqlist" style="">
                            <div class="accordion-body">هي منصة للخدمات الالكترونية تجمع بين العملاء و موفري الخدمات
                                في
                    ...
                    <div class="accordion-item mb-3 shadow-sm text-end border">
                        <h3 class="accordion-header mt-0">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-2222" aria-expanded="false">
                                <svg class="svg-inline--fa fa-circle-question fa-w-16 ms-2 text-success" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle-question" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0zM256 400c-18 0-32-14-32-32s13.1-32 32-32c17.1 0 32 14 32 32S273.1 400 256 400zM325.1 258L280 286V288c0 13-11 24-24 24S232 301 232 288V272c0-8 4-16 12-21l57-34C308 213 312 206 312 198C312 186 301.1 176 289.1 176h-51.1C225.1 176 216 186 216 198c0 13-11 24-24 24s-24-11-24-24C168 159 199 128 237.1 128h51.1C329 128 360 159 360 198C360 222 347 245 325.1 258z"></path></svg><!-- <i class="fas fa-question-circle ms-2 text-success"></i> Font Awesome fontawesome.com -->
                                ماهي خدمة الوكيل الالكتروني ؟
                            </button>
                        </h3>
                        <div id="faq-content-2222" class="accordion-collapse collapse" data-bs-parent="#faqlist" style="">
                            <div class="accordion-body">
                                خدمة تمكن الشركات من تكليف وكيل معتمد له خبرة تقنية و خبرة في الخدمات الحكومية لإنجاز و إدارة معاملاتها في
                                أي جهة
                                حكومية في أي مدينة .
                            </div>
                        </div>
                    ...
                    <div class="accordion-item mb-3 shadow-sm text-end border">
                        <h3 class="accordion-header mt-0">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-2222" aria-expanded="false">
                                <svg class="svg-inline--fa fa-circle-question fa-w-16 ms-2 text-success" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle-question" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0zM256 400c-18 0-32-14-32-32s13.1-32 32-32c17.1 0 32 14 32 32S273.1 400 256 400zM325.1 258L280 286V288c0 13-11 24-24 24S232 301 232 288V272c0-8 4-16 12-21l57-34C308 213 312 206 312 198C312 186 301.1 176 289.1 176h-51.1C225.1 176 216 186 216 198c0 13-11 24-24 24s-24-11-24-24C168 159 199 128 237.1 128h51.1C329 128 360 159 360 198C360 222 347 245 325.1 258z"></path></svg><!-- <i class="fas fa-question-circle ms-2 text-success"></i> Font Awesome fontawesome.com -->
                                من هو الوكيل الالكتروني ؟
                            </button>
                        </h3>
                        <div id="faq-content-2222" class="accordion-collapse collapse" data-bs-parent="#faqlist" style="">
                            <div class="accordion-body">
                                الوكيل الإلكتروني شخص متخصص في الخدمات الالكترونية و التقنية يستطيع إدارة طلبات الشركة و تنفيذها من خلاله أو
                                من خلال
                                مقدمي الخدمات في منصة معاملة مقابل نسبة .
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item mb-3 shadow-sm text-end border">
                        ...
                        <div id="faq-content-2222" class="accordion-collapse collapse" data-bs-parent="#faqlist" style="">
                            <div class="accordion-body">
                                يحصل الوكيل على نسبة 20 % من قيمة الطلب في حال تم إنجاز الطلب فقط .
                            </div>
                        </div>
                    </div>
                </div>
