    ...
    <div class="card card-style bg-theme pb-0">
        <div class="content">
            <div class="text-center mb-3">
                <h3 class="font-900 font-35">تسجيل جديد مقدم خدمة</h3>
            ...
            <div class="pt-2">
                <form method="post" action="{{ route('register') }}" enctype="multipart/form-data" role="form">
                    ...
                    <div class=" input-style input-style-2 has-icon input-required">
                        ...
                        <em>(مطلوب)</em>
                        <input class="form-control" name="name" required  type="text" placeholder="">
                    </div>
                    <div class=" input-style input-style-2 has-icon input-required">
                    ...
                    <div class=" input-style input-style-2 has-icon input-required">
                        ...
                        <em>(مطلوب)</em>
                        <input class="form-control" type="tel" name="phone" title="يجب ان يكون رقم هاتف سعودي" pattern="(05)([0-9]{8})" required  placeholder="">
                    </div>
                    ...
                    <div class="input-style input-style-2  has-icon input-required">
                        ...
                        <em>(مطلوب)</em>
                        <input class="form-control validate" id="psw-provider" type="password" autocomplete required title="يجب ان تحتوي كلمة السر على حروف وارقام ولا تقل عن 8 خانات" name="password" pattern="(?=.*\d)(?=.*[a-zA-Z]).{8,}" placeholder="">
                    </div>
                    <div class="input-style input-style-2  has-icon input-required">
                        <i class="fa input-icon fa-lock"></i>
                        <span class="color-highlight">تأكيد كلمة المرور</span>
                        <em>(مطلوب)</em>
                        <input class="form-control validate" type="password" id="password-confirmation-provider" required name="password_confirmation" placeholder="">
...
<script>
    ...
    var letter_provider = document.getElementById("letter");
    var number_provider = document.getElementById("number");
    var length_provider = document.getElementById("length");
    ...
    myInput_provider.onkeyup = function() {
        ...
        if (myInput_provider.value.match(characters) || myInput.value.match(characters2)) {
