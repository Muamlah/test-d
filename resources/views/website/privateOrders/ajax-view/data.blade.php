    ...
    <a href="{{route('privateOrder.show',@$item->id)}}" class="item">
        <div class="d-flex">
            ...
            <div class="align-self-center w-100">
                <p class="line-height-s font-12 pr-1 font-400">طلب تعميد  رقم {{$item->id}} <strong class="font-800">مقدم الخدمة</strong>  <strong class="font-800">@if(@$item->provider->name) {{@$item->provider->name}} @else {{@$item->provider->phone}}@endif</strong>
