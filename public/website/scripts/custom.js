...
$(document).ready(function () {
    ...
    function init_template() {
        ...
        setTimeout(function () {
            ...
            $('.f-slider').owlCarousel({ rtl: true, loop: true, margin: 0, nav: false, lazyLoad: false, items: 2, autoplay: true, autoplayTimeout: 4000 });
        ...
        var textareaValidator = /[^[\u0600-\u065F\u066A-\u06EF\u06FA-\u06FFa-zA-Z]+[\u0600-\u065F\u066A-\u06EF\u06FA-\u06FFa-zA-Z-_]*$/;
    ...
    if (isPWA === true) {
        ...
        function loadPWA() { }
        loadJS('/template-muamlah/scripts/pwa.js', loadPWA, document.body);
    }
